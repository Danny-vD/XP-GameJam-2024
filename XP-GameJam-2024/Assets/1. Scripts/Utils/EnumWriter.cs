...
namespace Utils
{
	public static class EnumWriter
	{
		...
		public static void WriteToEnum<TEnum>(string subPath, IEnumerable<string> values, IEnumerable<string> documentation) where TEnum : Enum
		{
			if (subPath != null)
			{
		...
		public static void WriteToEnum<TEnum>(IEnumerable<string> values, IEnumerable<string> documentation) where TEnum : Enum
		{
